...
sigma = 0.015
B_major = B_major*(1 + sigma*np.random.randn(B_major.shape[0]).reshape(-1,1))
...
plt.savefig('Figures/n3_1_HystRNN.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/n3_2_HystRNN.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/n3_3_HystRNN.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/n3_4_HystRNN.jpeg', dpi=500, bbox_inches="tight")
plt.show()
