...
model = HystRNN(input_size, hidden_size, output_size, dt=0.02)
...
plt.savefig('Figures/dt_41.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/dt_42.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/dt_43.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/dt_44.jpeg', dpi=500, bbox_inches="tight")
plt.show()
