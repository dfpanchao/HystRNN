...
with torch.no_grad():
    ...
    prediction_1, _ = model(test_input_tensor_1, (hidden_pred, cell_pred))
...
with torch.no_grad():
    hidden_pred = torch.zeros(1, batch_size, hidden_size)
    cell_pred = torch.zeros(1, batch_size, hidden_size)
    prediction_2, _ = model(test_input_tensor_2, (hidden_pred, cell_pred))
...
with torch.no_grad():
    hidden_pred = torch.zeros(1, batch_size, hidden_size)
    cell_pred = torch.zeros(1, batch_size, hidden_size)
    prediction_amp1, _ = model(test_input_tensor_amp1, (hidden_pred, cell_pred))
...
with torch.no_grad():
    hidden_pred = torch.zeros(1, batch_size, hidden_size)
    cell_pred = torch.zeros(1, batch_size, hidden_size)
    prediction_amp2, _ = model(test_input_tensor_amp2, (hidden_pred, cell_pred))
...
plt.savefig('Figures/a3_LSTM.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/d3_LSTM.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/g3_LSTM.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/j3_LSTM.jpeg', dpi=500, bbox_inches="tight")
plt.show()