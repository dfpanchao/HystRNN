...
def model(b, t, h_interp, dh_interp):
    h_val = h_interp(t)
    dh_val = dh_interp(t)
    dbdt = 0.403*np.abs(dh_val)*h_val - 0.087 * np.abs(dh_val)*b + 0.325*(dh_val)
    return dbdt
...
plt.savefig('Figures/duhem_reg_1.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/duhem_reg_2.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/duhem_reg_3.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/duhem_reg_4.jpeg', dpi=500, bbox_inches="tight")
plt.show()
