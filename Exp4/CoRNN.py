...
model = coRNN(input_size, hidden_size, output_size, dt=0.05, gamma=1.0, epsilon=0.01)
...
ax.set_xlabel(r"H[A/m]", fontsize=16, color='black')
ax.set_ylabel(r"B[T]", fontsize=16, color='black')
...
plt.savefig('Figures/a3_CoRNN.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/d3_CoRNN.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/g3_CoRNN.jpeg', dpi=500, bbox_inches="tight")
plt.show()
...
plt.savefig('Figures/j3_CoRNN.jpeg', dpi=500, bbox_inches="tight")
plt.show()